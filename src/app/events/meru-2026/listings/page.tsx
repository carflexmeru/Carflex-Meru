...
export default function MeruEventListings() {
    ...
    <div className="max-w-7xl mx-auto px-8 space-y-16">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="flex flex-col gap-2">
          <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Live Showground Inventory</p>
          ...
          <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px] mt-4">Forensic manifest of assets physically present at ASK Meru.</p>
        </div>
        ...
        <div className="nm-card p-6 flex gap-8 bg-primary/5">
           ...
           <div className="text-center">
              <p className="text-[8px] font-black uppercase text-zinc-500 tracking-widest mb-1">Exhibition Status</p>
