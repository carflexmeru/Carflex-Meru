...
export default function Meru10thMap() {
  const sectors = [
    { name: "ZONE A", description: "Premium Row & VIP Assets", icon: "diamond" },
    { name: "ZONE B", description: "Standard Display Lanes", icon: "agriculture" },
    { name: "ZONE C", description: "Entry Price KES 500", icon: "local_shipping" },
    { name: "MAIN GATE", description: "Public Access & Clearance", icon: "gate" },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 space-y-16">
      <div className="flex flex-col gap-2 text-center items-center">
        ...
        <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px] mt-4">Operational layout of the 10th edition arena.</p>
      </div>
