...
export default function Meru10thExhibitors() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 space-y-16">
      <div className="flex flex-col gap-2 text-center items-center">
        <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">10th Edition Partner Directory</p>
        ...
        <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px] mt-4">Registry of professional vendors currently on-site at the 10th edition bazaar.</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
           {exhibitors.map((ex) => (
             <div key={ex.id} className="nm-card p-10 flex flex-col items-center text-center space-y-6 group hover:bg-white/5 transition-all">
                ...
                <Link href={`/events/meru-10th-2026/listings?vendorId=${ex.id}`} className="w-full nm-card bg-[var(--surface)] text-foreground py-4 font-black uppercase tracking-widest text-[9px] hover:bg-primary hover:text-white transition-all border border-[var(--glass-border)]">
